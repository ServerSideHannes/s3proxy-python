...
from s3proxy.request_handler import _needs_body_for_signature
from s3proxy.routing.dispatcher import (
    HEADER_COPY_SOURCE,
    METHOD_DELETE,
    METHOD_GET,
    METHOD_HEAD,
...
# Use the static method from RequestDispatcher
_is_bucket_only_path = RequestDispatcher._is_bucket_only_path
...
class TestRoutingDecisions:
    ...
    def test_upload_part_copy_detected(self):
        ...
        is_upload_part_copy = (
            QUERY_UPLOAD_ID in query and method == METHOD_PUT and HEADER_COPY_SOURCE in headers
        )
